...
define(['pipAPI', 'pipScorer', 'underscore'], function (APIConstructor, Scorer, _) {
  ...
  **/
  ...
  // "במטלה שביצעת, 'Typ הקטגוריהe 1' depicted a person ייצגה אדם בעלesteem, and 'type 4'והקטגוריה icted a person with low seייצגה אדם בעל
  ...
  function qiatExtension (options) {
    ...
    var qiatObj = {
      ...
      category3: {
        name: 'highSE', // Will appear in the debrifing and the data.
        title: {
          // media : {word : "Type 3"}, //Name of the category presented in the task. if commented out, 'Type 3' or 'type 4' will be assigned randomly. Has an effect only if both category disply names and both hints are provided. You will also have to configure topLabel/bottomLabel and topInventory/bottomInventory below...
          // hint : {word : " - 3"}, //Hint appened to the stimuli of this category in the hinted practice block. if commented out, 'Type 3' or 'type 4' will be assigned randomly, and the hint will be added accordingly. Has an effect only if both category disply names and both hints are provided. You will also have to configure topLabel/bottomLabel and topInventory/bottomInventory below...
          css: {color: '#336600', 'font-size': '1.8em'}, // Style of the category title.
          height: 4 // Used to position the "Or" in the combined block.

        },
        stimulusMedia: [ // Stimuli content as PIP's media objects
          {word: 'אני מרגישה שאני אדם בעל ערך, לפחות כמו אנשים אחרים'},
          {word: 'אני מרגישה שיש לי מספר תכונות טובות'},
          {word: 'אני מסוגלת לעשות דברים כמו רב האנשים'},
          {word: 'אני נוקטת בגישה חיובית כלפי עצמי'},
          {word: 'באופן כללי, אני מרוצה מעצמי'}
        ],
        // Stimulus css (style)
        stimulusCss: {color: '#336600', 'font-size': '2.3em'}
      },
      category4: {
        name: 'lowSE', // Will appear in the debrifing and the data.
        title: {
          // media : {word : "type 4"}, //Name of the category presented in the task. if commented out, 'Type 3' or 'type 4' will be assigned randomly. Has an effect only if both category disply names and both hints are provided. You will also have to configure topLabel/bottomLabel and topInventory/bottomInventory below...
        ...
        stimulusMedia: [ // Stimuli content as PIP's media objects
          {word: 'סך הכול, אני נוטה להרגיש שאני כישלון'},
          {word: 'אני מרגישה שאין לי הרבה דברים להתגאות בהם'},
          {word: 'הלוואי והיה לי יותר כבוד כלפי עצמי'},
          {word: 'אני בהחלט מרגישה חסרת תועלת לעיתים'},
          {word: 'לעיתים אני חושבת שאני לא שווה כלל'}
        ],
        // Stimulus css
        stimulusCss: {color: '#336600', 'font-size': '2.3em'}
      },
      attribute2:
      {
        ...
        stimulusMedia: [ // Stimuli content as PIP's media objects
          {word: 'אני ממיינת משפטים'},
          {word: 'אני מסתכלת על מסך מחשב'},
          {word: 'אני משתתפת בניסוי בפסיכולוגיה'},
          {word: 'האצבעות שלי על המקלדת'},
          {word: 'אני יושבת מול מחשב'}
        ],
        // Stimulus css
      ...
      attribute1:
      {
        ...
        stimulusMedia: [ // Stimuli content as PIP's media objects
          {word: 'אני מטפסת על הר תלול'},
          {word: 'אני יושבת על החול בחוף הים'},
          {word: 'אני מנגנת בגיטרה החשמלית שלי'},
          {word: 'אני משחקת כדורגל על הדשא'},
      ...
      randomBlockOrder: true, // Accepts 'true' and 'false'. If false, then category3 on the left first.
      ...
      // In the block4Cond variable: "att1/cat3,att2/cat4" means att1 and cat3 on the left, att2 and cat4 on the right.
      ...
      'אם תבצעי טעות יופיע על המסך <font color="#ff0000"><b>X</b></font>. ' +
      'תקני את הטעות בעזרת המקש האחר.<p/>',
      ...
      leftKeyText: 'הקישי על המקש "E" עבור',
      rightKeyText: 'הקישי על המקש "I" עבור',
      ...
      instAttributePractice: '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        ...
        '<font size="4.4px">הקישי על המקש <b>E</b> כאשר הפריט מתאים לקטגוריה <font color="#0000ff">leftAttribute.</font>' +
        '<br/><font size="4.4px">הקישי על המקש <b>I</b> כאשר הפריט מתאים לקטגוריה <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
        'אם תבצעי טעות יופיע על המסך <font color="#ff0000"><b>X</b></font>. ' +
        'תקני את הטעות בעזרת המקש האחר.<br/>' +
        'השתדלי למיין <u>מהר ככל האפשר</u> אבל עם כמה שפחות טעויות.<br/><br/></p>' +
      ...
      instCategoriesPracticeHinted: '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        '<font color="#000000"><u>סיבוב blockNum מתוך nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:right; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'שימי לב, בסיבוב הבא הקטגוריות שבראש המסך שונות, אך המשימה זהה.<br/> ' +
        ...
        '<font size="4.4px">הקישי על המקש <b>E</b> כאשר הפריט מתאים לקטגוריה <font color="#336600">leftCategory.</font>' +
        '<br/><font size="4.4px">הקישי על המקש <b>I</b> כאשר הפריט מתאים לקטגוריה <font color="#336600">rightCategory</font>.<br/><br/>' +
      ...
      instCategoriesPractice: '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        '<font color="#000000"><u>סיבוב blockNum מתוך nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:right; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'האם את זוכרת איזה פריטים מתאימים לטיפוסים השונים?<br/>' +
        'שימי לב, המשימה בסיבוב הבא זהה למשימה בסיבוב הקודם, אך כעת לא יופיעו רמזים.<br/>' +
      ...
      instFirstCombined: '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        '<font color="#000000"><u>סיבוב blockNum מתוך nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:right; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'בסיבוב הבא תמייני פריטים לארבע הקטגוריות אליהן מיינת פריטים בסיבובים הקודמים.<br/>' +
        '<u>כל פריט מתאים לקטגוריה אחת בלבד.</u> <br/><br/>' +
        'הקישי על המקש <b>E</b> עבור פריטים השייכים לקטגוריה <font color="#336600">leftCategory</font> או לקטגוריה <font color="#0000ff">leftAttribute</font>.<br/>' +
        'הקישי על המקש <b>I</b> עבור פריטים השייכים לקטגוריה <font color="#336600">rightCategory</font> או לקטגוריה <font color="#0000ff">rightAttribute</font>.<br/>' +
        '<br/>' +
        'אם תבצעי טעות יופיע על המסך <font color="#ff0000"><b>X</b></font>. ' +
        'תקני את הטעות בעזרת המקש האחר.<br/>' +
        'השתדלי למיין <u>מהר ככל האפשר</u> אבל עם כמה שפחות טעויות.<br/><br/></p>' +
      ...
      instSwitchCategories: '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        '<font color="#000000"><u>סיבוב blockNum מתוך nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:right; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        '<b>שימי לב, בסיבוב הבא הקטגוריות שבראש המסך החליפו צדדים, אך המשימה זהה!</b><br/>' +
        'הקישי על המקש <b>E</b> עבור פריטים השייכים לקטגוריה <font color="#336600">leftCategory</font>.<br/>' +
        'הקישי על המקש <b>I</b> עבור פריטים השייכים לקטגוריה <font color="#336600">rightCategory</font>.<br/>' +
        '<br/>' +
        'השתדלי למיין <u>מהר ככל האפשר</u> אבל עם כמה שפחות טעויות.<br/><br/></p>' +
        '<p align="center">להמשך, נא ללחוץ על רווח</font></p></div>',
    ...
    var type3ascategory3 = []
    var category3name = []
    var category4name = []
    var category3append = []
    var category4append = []
    var manualCatDisplayNames = (typeof qiatObj.category3.title.media !== 'undefined' & typeof qiatObj.category4.title.media !== 'undefined' & typeof qiatObj.category3.title.hint !== 'undefined' & typeof qiatObj.category4.title.hint !== 'undefined')

    if (manualCatDisplayNames) { // The display names for the categories were defined manually (and properly)
      type3ascategory3 = 'no - manually defined'
      category3name = qiatObj.category3.title.media.word
      category4name = qiatObj.category4.title.media.word
      category3append = qiatObj.category3.title.hint.word
      category4append = qiatObj.category4.title.hint.word
    } else { // The display names for the categories were defined by the qiat extension
      type3ascategory3 = API.shuffle([true, false])[0]
      category3name = type3ascategory3 === true ? 'טיפוס 3' : 'טיפוס 4'
      category4name = type3ascategory3 === true ? 'טיפוס 4' : 'טיפוס 3'
      category3append = type3ascategory3 === true ? ' - 3' : ' - 4'
      category4append = type3ascategory3 === true ? ' - 4' : ' - 3'
      qiatObj.category3.title.media = { word: category3name }
      qiatObj.category4.title.media = { word: category4name }
      qiatObj.category3.title.hint = { word: category3append }
      qiatObj.category4.title.hint = { word: category4append }
    }
    ...
    API.addGlobal({
      type3ascategory3: type3ascategory3
    })
    API.save({
      type3ascategory3: API.getGlobal().type3ascategory3
    })

    piCurrent.category4practice = cloneObject(piCurrent.category4)
    piCurrent.category3practice = cloneObject(piCurrent.category3)
    // append the hints, and scale by number of stimuli in each category
    for (var i1 in piCurrent.category3practice.stimulusMedia) {
      piCurrent.category3practice.stimulusMedia[i1].word = piCurrent.category3practice.stimulusMedia[i1].word + category3append
    }
    for (var i2 in piCurrent.category4practice.stimulusMedia) {
      piCurrent.category4practice.stimulusMedia[i2].word = piCurrent.category4practice.stimulusMedia[i2].word + category4append
    }
    ...
    var cat3stimuliobject = []
    for (stimuliobject of piCurrent.category3.stimulusMedia) {
      cat3stimuliobject.push(stimuliobject.word)
    }
    // sets the prefix for the first element
    // concatenate the stimuli to a single string in html format
    var cat3stimuliobjectHtml = [
      '<div dir="rtl" style="margin-left: auto; margin-right: auto; display: table; width: 700px;">',
      ...
      '<li>',
      cat3stimuliobject.join('</li><li>'),
      '</li></font></ul></div>'
    ].join('')

    var cat4stimuliobject = []
    for (stimuliobject of piCurrent.category4.stimulusMedia) {
      cat4stimuliobject.push(stimuliobject.word)
    }
    // sets the prefix for the first element
    // concatenate the stimuli to a single string in html format
    var cat4stimuliobjectHtml = [
      '<div dir="rtl" style="margin-left: auto; margin-right: auto; display: table; width: 700px;">',
      '<ul dir="rtl" style="text-align: justify; margin: 10px 0; list-style-position:inside; list-style-type:disk;">',
      '<font color="#336600" size="4px">',
      '<li>',
      cat4stimuliobject.join('</li><li>'),
      '</li></font></ul></div>'
    ].join('')
    ...
    if (type3ascategory3 === true) {
      topLabel = category3name
      bottomLabel = category4name
      topInventory = cat3stimuliobjectHtml
      bottomInventory = cat4stimuliobjectHtml
    } else {
      topLabel = category4name
      bottomLabel = category3name
      topInventory = cat4stimuliobjectHtml
      bottomInventory = cat3stimuliobjectHtml
    }

    piCurrent.instAttributeInventory = '<div dir="rtl"><p align="center" style="font-size:20px; font-family:arial">' +
        '<font color="#000000"><u>סיבוב blockNum מתוך nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:center; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'אלה הפריטים שתתבקשי למיין בסיבוב הבא:<br/><br/>' +
        '<center>' +
          '<font color="#0000ff"><b>' +
    ...
    var cat3 = piCurrent.category3
    var cat4 = piCurrent.category4
    var cat3practice = piCurrent.category3practice
    var cat4practice = piCurrent.category4practice
    if (isTouch) {
      ...
      cat3.stimulusCss.maxWidth = maxW
      cat4.stimulusCss.maxWidth = maxW
      cat3practice.stimulusCss.maxWidth = maxW
      cat4practice.stimulusCss.maxWidth = maxW
      att1.stimulusCss.maxHeight = maxH
      att2.stimulusCss.maxHeight = maxH
      cat3.stimulusCss.maxHeight = maxH
      cat4.stimulusCss.maxHeight = maxH
      cat3practice.stimulusCss.maxHeight = maxH
      cat4practice.stimulusCss.maxHeight = maxH
    }
    ...
    if (manualCatDisplayNames) { // The display name for the categories were defined manually (properly)
      ...
      if (type3ascategory3) { // this if condition makes sure that we always first describe type 3, and later type 4.
        typePairing = "במטלה שביצעת הקטגוריה, '" + category3name + "' ייצגה אדם בעל " + cat3.name + ", והקטגוריה '" + category4name + "' ייצגה אדם בעל " + cat4.name + '.'
      } else {
        typePairing = "במטלה שביצעת הקטגוריה, '" + category4name + "' ייצגה אדם בעל " + cat4.name + ", והקטגוריה '" + category3name + "' ייצגה אדם בעל " + cat3.name + '.'
      }
    }
    API.addGlobal({
  ...
  */
   ...
   */
    ...
    basicTrialSets.cat3left =
    createBasicTrialSet({side: 'left', stimSet: 'cat3'})
    basicTrialSets.cat3right =
    createBasicTrialSet({side: 'right', stimSet: 'cat3'})
    basicTrialSets.cat4left =
    createBasicTrialSet({side: 'left', stimSet: 'cat4'})
    basicTrialSets.cat4right =
    createBasicTrialSet({side: 'right', stimSet: 'cat4'})
    // Four trials for the hinted categories.
    basicTrialSets.cat3leftpractice =
    createBasicTrialSet({side: 'left', stimSet: 'cat3practice'})
    basicTrialSets.cat3rightpractice =
    createBasicTrialSet({side: 'right', stimSet: 'cat3practice'})
    basicTrialSets.cat4leftpractice =
    createBasicTrialSet({side: 'left', stimSet: 'cat4practice'})
    basicTrialSets.cat4rightpractice =
    createBasicTrialSet({side: 'right', stimSet: 'cat4practice'})
   ...
   */
    ...
    [{
      ...
      cat3:
    [{
      data: {alias: cat3.name},
      inherit: 'target',
      css: cat3.stimulusCss,
      media: {inherit: {type: 'exRandom', set: 'cat3'}}
    }],
      cat4:
    [{
      data: {alias: cat4.name},
      inherit: 'target',
      css: cat4.stimulusCss,
      media: {inherit: {type: 'exRandom', set: 'cat4'}}
    }],
      cat3practice:
    [{
      data: {alias: cat3practice.name},
      inherit: 'target',
      css: cat3practice.stimulusCss,
      media: {inherit: {type: 'exRandom', set: 'cat3practice'}}
    }],
      cat4practice:
    [{
      data: {alias: cat4practice.name},
      inherit: 'target',
      css: cat4practice.stimulusCss,
      media: {inherit: {type: 'exRandom', set: 'cat4practice'}}
    }],
   ...
   */
    API.addMediaSets({
      ...
      cat3: cat3.stimulusMedia,
      cat4: cat4.stimulusMedia,
      cat3practice: cat3practice.stimulusMedia,
      cat4practice: cat4practice.stimulusMedia
    })
   ...
   */
    ...
    // Set sides
    var rightCatName = (globalObj.randomBlockOrder ? (Math.random() >= 0.5 ? cat3.name : cat4.name) : cat4.name)
    var leftCatTrial = 'cat3leftpractice'
    blockParamsCats.left1 = cat3practice
    var rightCatTrial = 'cat4rightpractice'
    blockParamsCats.right1 = cat4practice
    if (rightCatName === cat3practice.name) {
      blockParamsCats.right1 = cat3practice
      rightCatTrial = 'cat3rightpractice'
      blockParamsCats.left1 = cat4practice
      leftCatTrial = 'cat4leftpractice'
    }
    ...
    // Set sides
    rightCatName = (globalObj.randomBlockOrder ? (Math.random() >= 0.5 ? cat3.name : cat4.name) : cat4.name)
    leftCatTrial = 'cat3left'
    blockParamsCats.left1 = cat3
    rightCatTrial = 'cat4right'
    blockParamsCats.right1 = cat4
    if (rightCatName === cat3.name) {
      blockParamsCats.right1 = cat3
      rightCatTrial = 'cat3right'
      blockParamsCats.left1 = cat4
      leftCatTrial = 'cat4left'
    }
    ...
    rightCatTrial = (rightCatTrial === 'cat3right') ? 'cat4right' : 'cat3right'
    leftCatTrial = (leftCatTrial === 'cat3left') ? 'cat4left' : 'cat3left'
  ...
  **/
    ...
    scorer.addSettings('compute', {
      ...
      // condition 1
      cond1VarValues: [
        cat3.name + '/' + att1.name + ',' + cat4.name + '/' + att2.name,
        cat4.name + '/' + att2.name + ',' + cat3.name + '/' + att1.name
      ],
      // condition 2
      cond2VarValues: [
        cat4.name + '/' + att1.name + ',' + cat3.name + '/' + att2.name,
        cat3.name + '/' + att2.name + ',' + cat4.name + '/' + att1.name
      ],
    ...
    var messageDef = [
      { cut: '-0.65', message: getFB(piCurrent.fb_strong_Att1WithCatA_Att2WithCatB, category3name, category4name) },
      { cut: '-0.35', message: getFB(piCurrent.fb_moderate_Att1WithCatA_Att2WithCatB, category3name, category4name) },
      { cut: '-0.15', message: getFB(piCurrent.fb_slight_Att1WithCatA_Att2WithCatB, category3name, category4name) },
      { cut: '0.15', message: getFB(piCurrent.fb_equal_CatAvsCatB, category3name, category4name) },
      { cut: '0.35', message: getFB(piCurrent.fb_slight_Att1WithCatA_Att2WithCatB, category4name, category3name) },
      { cut: '0.65', message: getFB(piCurrent.fb_moderate_Att1WithCatA_Att2WithCatB, category4name, category3name) },
      { cut: '5', message: getFB(piCurrent.fb_strong_Att1WithCatA_Att2WithCatB, category4name, category3name) }
    ]
