    ...
    var qiatObj = {
      ...
      category3: {
        ...
        stimulusMedia: [ // Stimuli content as PIP's media objects
          {word: 'אני מרגיש שאני אדם בעל ערך, לפחות כמו אנשים אחרים'},
          {word: 'אני מרגיש שיש לי מספר תכונות טובות'},
          {word: 'אני מסוגל לעשות דברים כמו רב האנשים'},
          {word: 'אני נוקט בגישה חיובית כלפי עצמי'},
      ...
      category4: {
        ...
        stimulusMedia: [ // Stimuli content as PIP's media objects
          ...
          {word: 'אני מרגיש שאין לי הרבה דברים להתגאות בהם'},
          {word: 'הלוואי והיה לי יותר כבוד כלפי עצמי'},
          {word: 'אני בהחלט מרגיש חסר תועלת לעיתים'},
          {word: 'לעיתים אני חושב שאני לא שווה כלל'}
        ],
        // Stimulus css
        stimulusCss: {color: '#336600', 'font-size': '2.3em'}
      },
