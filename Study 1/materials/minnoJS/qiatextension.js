...
define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	**/
    ...
    //"In task you just performed, 'Type 1' depicted a person with high self-esteem, and 'Type 2' depicted a person with low self-esteem".
	...
	function qiatExtension(options)
	{
		...
		var qiatObj = {
			...
			category1 : {
    			name : "High Self-Esteem", //Will appear in the debrifing and the data.
    			title : {
    			...
    			stimulusMedia : [ //Stimuli content as PIP's media objects
    				{word: 'On the whole, I am satisfied with myself'},
    				{word: 'I feel that I have a number of good qualities'},
    				{word: 'I am able to do things as well as most other people'},
    				{word: 'I feel that I’m a person of worth, at least on an equal plane with others'},
    				{word: 'I take a positive attitude toward myself'}
    			],
    			//Stimulus css (style)
    			stimulusCss : {color:'#336600','font-size':'2.3em'}
    		},
    		category2 :	{
    			name : "Low Self-Esteem", //Will appear in the debrifing and the data.
    			title : {
    			...
    			stimulusMedia : [ //Stimuli content as PIP's media objects
    				{word: 'At times, I think I am no good at all'},
    				{word: 'I feel I do not have much to be proud of'},
    				{word: 'I certainly feel useless at times'},
    				{word: 'I wish I could have more respect for myself'},
    				{word: 'All in all, I am inclined to feel that I am a failure'}
    			],
    			//Stimulus css
    			stimulusCss : {color:'#336600','font-size':'2.3em'}
    		},
    		attribute2 :
    		{
    			...
    			stimulusMedia : [ //Stimuli content as PIP's media objects
    				{word: 'I am completing a computer task'},
    				{word: 'I am using the computer'},
    				{word: 'I am breathing air'},
    				{word: 'I have my fingers placed on the keyboard'},
    		...
    		attribute1 :
    		{
    			...
    			stimulusMedia : [ //Stimuli content as PIP's media objects
    				{word: 'I am playing football'},
    				{word: 'I am sunbathing at the beach'},
    				{word: 'I am currently playing an electric guitar'},
    				{word: 'I am climbing a steep mountain'},
    				{word: 'I am buying groceries in the local grocery store'}
    			],
    			//Stimulus css
    			stimulusCss : {color:'#0000FF','font-size':'2.3em'}
    		},
            ...
            instCategoriesPracticeHinted: '<div><p align="center" style="font-size:20px; font-family:arial">' +
                '<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
                '<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
                ...
                '<font size="4.4px">Put a left finger on the <b>E</b> key for statements that belong to the category <font color="#336600">leftCategory</font>. ' +
                '<br/><font size="4.4px">Put a right finger on the <b>I</b> key for statements that belong to the category <font color="#336600">rightCategory</font>.<br/>' +
                '<p align="center">Press the <b>space bar</b> when you are ready to start.</font></p></div>',
    ...
    if (manualCatDisplayNames)
		{//The display names for the categories were defined manually (and properly)
		...
		{//The display names for the categories were defined by the qiat extension
			type1ascategory1 = API.shuffle([true, false])[0];
            category1name = type1ascategory1 === true ? 'Type 1' : 'Type 2';
            category2name = type1ascategory1 === true ? 'Type 2' : 'Type 1';
    ...
    var stimuliobject;
    for (stimuliobject of piCurrent.category1practice.stimulusMedia) {
        stimuliobject.word = stimuliobject.word + category1append;
    }
    for (stimuliobject of piCurrent.category2practice.stimulusMedia) {
        stimuliobject.word = stimuliobject.word + category2append;
    }
    
    //create the instructions slides where all the statements are presented
    piCurrent.instAttributeInventory = '<div><p align="center" style="font-size:20px; font-family:arial">' +
                '<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
    ...
    var att1stimuliobjectHtml = [
        '<div style="margin-left: auto; margin-right: auto; display: table; width: 700px;">',
        '<ul style="text-align: left; margin: 10px 0; list-style-position:inside; list-style-type:disk;">',
...
if(type1ascategory1 === true) {
    ...
    piCurrent.instAttributeInventory =  '<div><p align="center" style="font-size:20px; font-family:arial">' +
                ...
                '</center><br/>' +
                'To continue reading the instructions, press the space bar.' + 
                '</p></div>';
    piCurrent.instAttributeInventoryTouch = [
                'table { border-collapse: separate; border-spacing: 5px; } <div>',
                    '<p align="center">',
                        '<u>Part blockNum of nBlocks</u>',
                    '</p>',
                    '<p align="center" style="margin-left:5px">',
    ...
    piCurrent.instCategoryInventory =  '<div><p align="center" style="font-size:20px; font-family:arial">' +
                '<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
                '<p style="font-size:20px; text-align:center; vertical-align:bottom; margin-left:10px; font-family:arial">' +
                'Here are the statements you will classify in the next part:<br/><br/>' + 
                '<center>' +
                    '<font color="#336600"><b>' + topLabel + ' Statements</b></font>' +
                        topInventory +
                        '<br/>' +
                    '<font color="#336600"><b>' + bottomLabel + ' Statements</b></font>' +
                        bottomInventory +
                '</center><br/>' +
                'To continue reading the instructions, press the space bar.' + 
                '</p></div>';
    ...
    if (manualCatDisplayNames)
		{//The display name for the categories were defined manually (properly)
		    typePairing = ""; //We have no way of knowing this... 
	}
	else
	{//The display name for the categories defined by the extension
		if (type1ascategory1) { //this if condition makes sure that we always first describe type 1, and later type 2.
            typePairing = "In task you just performed, \'" + category1name + "\' depicted a person with " + cat1.name + ", and \'" + category2name + "\' depicted a person with " + cat2.name +".";    
        }
        else {
            typePairing = "In task you just performed, \'" + category2name + "\' depicted a person with " + cat2.name + ", and \'" + category1name + "\' depicted a person with " + cat1.name +".";    
	    }
	}
    API.addGlobal({
	...
	*/
	...
	API.addMediaSets({
		...
		cat1practice : cat1practice.stimulusMedia, cat2practice : cat2practice.stimulusMedia
	});
...
//helper function for creating an instructions trial
	...
	////Second combined block.
	if (globalObj.nBlocks == 8)
	{//Fifth block is another combined block.
		iBlock++;
		blockParamsCombined.blockNum = iBlock;
		blockParamsCombined.nMiniBlocks = globalObj.blockSecondCombined_nMiniBlocks;
		blockParamsCombined.nTrials = globalObj.blockSecondCombined_nTrials;
